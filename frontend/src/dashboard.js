    ...
    return (
        <div className="dashboard-container">
            <div className="number-cards-container">
                ...
                <NumberCard title="Tichete în aşteptare" fetchUrl="/api/ticket_summary/pendingTickets"
                            cardType="pending-tickets"/>
                <NumberCard title="Tichete Deschise" fetchUrl="/api/ticket_summary/activeTickets"
                            cardType="open-tickets"/>
                <NumberCard title="Tichete Închise" fetchUrl="/api/ticket_summary/resolvedTickets"
